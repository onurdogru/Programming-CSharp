...
namespace ProgrammingStation
{
    ...
    internal sealed class Prog_Ayarlar : ApplicationSettingsBase
    {
        ...
        public string STPNGdosyayolu
        {
            get
            {
                return (string)this[nameof(STPNGdosyayolu)];
            }
            set
            {
                this[nameof(STPNGdosyayolu)] = (object)value;
            }
        }
        ...
        [DebuggerNonUserCode]
        [DefaultSettingValue("Kitaplıklar\\Belgeler\\logpersonel.accdb")]
        public string REPNGdosyayolu
        {
            get
            {
                return (string)this[nameof(REPNGdosyayolu)];
            }
            set
            {
                this[nameof(REPNGdosyayolu)] = (object)value;
            }
        }
        ...
        [DebuggerNonUserCode]
        [DefaultSettingValue("Kitaplıklar\\Belgeler\\logpersonel.accdb")]
        public string MCPNGdosyayolu
        {
            get
            {
                return (string)this[nameof(MCPNGdosyayolu)];
            }
            set
            {
                this[nameof(MCPNGdosyayolu)] = (object)value;
            }
        }
