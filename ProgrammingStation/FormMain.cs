    ...
    public partial class FormMain : Form
    {
        ...
        private void FormMain_Load(object sender, EventArgs e)
        {
            ...
            */
            ...
            batchName = "ST_Romanya";

            this.cardPicture.ImageLocation = Prog_Ayarlar.Default.STPNGdosyayolu;
        ...
        private void ProgramThreadFunction()
        {
            ...
            ConsoleAppendLine(batchName + " Harvest Fresh ürününün programlama işlemi yapılıyor...", Color.Yellow);

            if (ProgramProduct())
            {
                ConsoleNewLine();
                ConsoleAppendLine(batchName + " Harvest Fresh ürününün programlama işlemi başarıyla tamamlanmıştır.", Color.Green);
                ConsoleNewLine();
                result = true;
            }
            else
            {
                ConsoleNewLine();
                ConsoleAppendLine(batchName + " Harvest Fresh ürününün programlama işlemi sırasında bir hata oluşmuştur!", Color.Red);
                ConsoleNewLine();
                result = false;
            }
        ...
        private void rbSTRomanya_CheckedChanged(object sender, EventArgs e)
        {
            this.cardPicture.ImageLocation = Prog_Ayarlar.Default.STPNGdosyayolu;
            batchName = "ST_Romanya";
        }

        private void rbSTEBI_CheckedChanged(object sender, EventArgs e)
        {
            this.cardPicture.ImageLocation = Prog_Ayarlar.Default.STPNGdosyayolu;
            batchName = "ST_EBI";
        }

        private void rbSTPakistan_CheckedChanged(object sender, EventArgs e)
        {
            this.cardPicture.ImageLocation = Prog_Ayarlar.Default.STPNGdosyayolu;
            batchName = "ST_Pakistan";
        }

        private void rbSTUVC_CheckedChanged(object sender, EventArgs e)
        {
            this.cardPicture.ImageLocation = Prog_Ayarlar.Default.STPNGdosyayolu;
            batchName = "ST_UVC";
        }

        private void rbRenesasRomanya_CheckedChanged(object sender, EventArgs e)
        {
            this.cardPicture.ImageLocation = Prog_Ayarlar.Default.REPNGdosyayolu;
            batchName = "RE_Romanya";
        }

        private void rbRenesasEBI_CheckedChanged(object sender, EventArgs e)
        {
            this.cardPicture.ImageLocation = Prog_Ayarlar.Default.REPNGdosyayolu;
            batchName = "RE_EBI";
        }

        private void rbRenesasPakistan_CheckedChanged(object sender, EventArgs e)
        {
            this.cardPicture.ImageLocation = Prog_Ayarlar.Default.REPNGdosyayolu;
            batchName = "RE_Pakistan";
        }

        private void rbRenesasIND_CheckedChanged(object sender, EventArgs e)
        {
            this.cardPicture.ImageLocation = Prog_Ayarlar.Default.REPNGdosyayolu;
            batchName = "RE_IND";
        }

        private void rbMicrochipRomanya_CheckedChanged(object sender, EventArgs e)
        {
            this.cardPicture.ImageLocation = Prog_Ayarlar.Default.MCPNGdosyayolu;
            batchName = "MC_Romanya";
        }

        private void rbMicrochipEBI_CheckedChanged(object sender, EventArgs e)
        {
            this.cardPicture.ImageLocation = Prog_Ayarlar.Default.MCPNGdosyayolu;
            batchName = "MC_EBI";
        }

        private void rbMicrochipPakistan_CheckedChanged(object sender, EventArgs e)
        {
            this.cardPicture.ImageLocation = Prog_Ayarlar.Default.MCPNGdosyayolu;
            batchName = "MC_Pakistan";
        }

        private void rbMicrochipUVC_CheckedChanged(object sender, EventArgs e)
        {
            this.cardPicture.ImageLocation = Prog_Ayarlar.Default.MCPNGdosyayolu;
            batchName = "MC_UVC";
        }
